;(function (window) {
  ...
  let texts = ['MY DEAR', 'LOOK UP AT THE', 'STARRY SKY', 'ARE YOU', 'LOOKING AT THE', 'SAME STAR', 'WITH ME ?', 'HAPPY', 'VALENTINE\'S', 'PROPOSE DAY TO YOU', 'BE WITH ME ALWAYS', 'I MISS YOU LOTS NIDHI :(']
